  ...
  <div class="card card-vuexy p-4">
    ...
    <div class="table-responsive">
      <table class="table table-hover align-middle mb-0">
        <thead>
          <tr>
            <th @click="sortByField('name', 'fetchCategories')" class="cursor-pointer">
              Category Name
            </th>
            <th @click="sortByField('status', 'fetchCategories')" class="cursor-pointer">Status</th>
            <th @click="sortByField('products_count', 'fetchCategories')" class="cursor-pointer">
              Products Count
            </th>
            <th @click="sortByField('created_at', 'fetchCategories')" class="cursor-pointer">
              Created Date
            </th>
    ...
    >
      <small class="text-muted fs-8"
        ...
        {{ Math.min(currentPage * perPage, categoriesCount) }} of
        {{ categoriesCount }} entries</small
      >
      <nav>
