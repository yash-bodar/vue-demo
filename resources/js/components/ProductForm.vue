        ...
        <div class="row g-4">
          ...
          <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4 overflow-hidden bg-white">
              <div
                class="card-header bg-gradient-primary text-light bg-primary-linear py-3 px-4 d-flex justify-content-between align-items-center border-0"
              >
                <div>
                ...
                <button
                  type="button"
                  class="btn btn-light btn-sm rounded-pill px-3 shadow-sm text-primary fw-semibold"
                  @click="addVariant"
                >
              ...
              <div class="card-body p-4">
                ...
                >
                  ...
                  <small class="text-muted d-block mt-1"
                    >This product will sell as a single item using the base price & quantity
                    above.</small
                  >
                </div>
                ...
                <div v-else class="d-flex flex-column gap-3">
                  <div
                    ...
                    :key="index"
                    class="p-3 bg-light rounded-4 border position-relative transition-all"
                  >
                    <div
                    ...
                    >
                      <div class="d-flex align-items-center gap-2">
                        <span
                          class="badge bg-primary text-white px-3 py-2 rounded-pill fw-bold fs-8"
                        >
                          Variant Option #{{ index + 1 }}
                        </span>
                        <span
                          v-if="variant.sku"
                          class="badge bg-white text-dark border rounded-pill px-2 py-1 small"
                        >
                          SKU: {{ variant.sku }}
                        </span>
                      </div>
                      <button
                        type="button"
                        class="btn btn-link text-danger p-0 border-0 fs-5 shadow-none"
                    ...
                    <div class="row g-3 align-items-end">
                      <div class="col-md-3 col-6">
                        ...
                        <select
                          ...
                          class="form-select variant-input-field rounded-3 shadow-none border"
                          @change="updateVariantName(variant)"
                        >
                      ...
                      <div class="col-md-6 col-12">
                        ...
                        <div class="input-group">
                          <span
                            class="input-group-text bg-white text-muted border-end-0 rounded-start-3"
                            ><i class="fas fa-tag"></i
                          ></span>
                          <input
                            v-model="variant.name"
                            class="form-control variant-input-field rounded-end-3"
                      ...
                      <div class="col-md-4 col-6">
                        ...
                        <div class="input-group">
                          <span
                            class="input-group-text bg-white text-primary fw-bold border-end-0 rounded-start-3"
                            >{{ form.currency }}</span
                          >
                          <input
                      ...
                      <div class="col-md-4 col-6">
                        ...
                        <div class="input-group">
                          ...
                          <input
                            ...
                            class="form-control variant-input-field rounded-end-3 fw-bold text-primary"
                            type="number"
                            min="0"
                            required
                          />
            ...
            <div class="mb-4">
              ...
              <div class="border rounded p-3 bg-light">
                ...
                />
                <div
                  v-if="existingImage || (form.image && typeof form.image === 'string')"
                  class="mt-3"
                >
                  <small class="text-muted d-block fw-semibold mb-1">Current Image Preview:</small>
                  <img
                    :src="getImageUrl(existingImage || form.image)"
                    class="img-thumbnail mt-1 shadow-sm rounded-3 product-thumb-60"
                  />
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      this.$axios.post('/api/products', formData).then(() => this.$router.push('/products'))
    },
