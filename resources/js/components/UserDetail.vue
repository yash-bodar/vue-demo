    ...
    <div class="user-body p-4">
      ...
      <div v-else-if="user">
            ...
            <div class="card shadow-sm border-0 rounded-3 mb-4">
              <div class="card-body text-center">
                <div class="position-relative d-inline-block mb-3">
                  <img
                    :src="profileImage"
                    class="rounded-circle border-4 border-white shadow-lg user-avatar"
                    alt="Profile Picture"
                  />
                </div>
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-6 col-sm-12">
                    <div class="text-center mt-2">
                      <router-link
                        class="btn btn-outline-primary rounded-2 px-4 w-100"
        ...
        <div class="card shadow-sm rounded-3 border-0 overflow-hidden">
          <div
            class="card-header bg-gradient-primary text-light py-3 px-4 border-0 bg-primary-linear"
          >
            <div class="row align-items-center">
              <div class="col-12 col-md-auto">
                <h5 class="mb-0 fw-bold d-flex align-items-center">
                  <i class="fas fa-shopping-bag me-2"></i>User Orders
                  <span class="badge bg-white color-primary ms-2 px-2 py-1 small fw-semibold">{{
                    ordersCount
                  }}</span>
                </h5>
              </div>
          ...
          <div class="card-body p-0">
                  ...
                  >
                    ...
                    <td>
                      <span class="fw-bold text-primary"
                        >{{ order.currency_sign || '$' }} {{ order.total_amount }}</span
                      >
                    </td>
                    <td>
                    ...
                    <td>
                      <div class="btn-group gap-2">
                        <button
                          class="btn btn-sm btn-outline-primary p-2 fw-semibold rounded-1"
            ...
            <div class="card-footer bg-white border-0 p-3" v-if="lastPage > 1">
              <div
                class="d-flex justify-content-between align-items-center flex-wrap gap-2 pagination-div"
              >
                <span class="text-muted small"
                  >Showing {{ (currentPage - 1) * perPage + 1 }} to
                  {{ Math.min(currentPage * perPage, ordersCount) }} of {{ ordersCount }}</span
                >
                <div class="d-flex gap-1">
                  ...
                  <button
                    ...
                    class="btn opacity-100 rounded-2 btn-sm"
                    :class="
                      page === currentPage
                        ? 'bg-primary btn-outline-primary text-white'
