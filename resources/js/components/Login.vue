        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6 d-none d-lg-flex auth-left-banner text-center text-white">
            ...
            <p class="text-white-50 px-4 mb-4">
              Access your personal account to manage orders, track wishlists, and explore premium items.
            </p>
          ...
          <div class="col-lg-6 auth-right-form">
            <div class="d-flex flex-column h-100 justify-content-center">
              <div class="mb-4">
                <h3 class="auth-title-gradient mb-2">Login</h3>
              ...
              <form @submit.prevent="submitForm">
                ...
                <div class="mb-4">
                  <div class="d-flex justify-content-between align-items-center mb-1">
                    ...
                    <router-link to="/forgot-password" class="text-link-premium small">Forgot Password?</router-link>
                  </div>
                  <div class="premium-input-group">
                    <input 
                ...
                <button 
                  ...
                  :disabled="loading"
                >
                  <span v-if="loading"><i class="fas fa-circle-notch fa-spin me-2"></i>Signing in...</span>
